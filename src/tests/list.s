...
Main..new:              ## constructor for Main
			...
			movq %rax, %r12
                        ...
                        movq %r14, 16(%r12)
                        ## initialize attributes
                        ## self[3] holds field mylist (List)
                        movq $0, %r13
                        movq %r13, 24(%r12)
                        ## self[3] mylist initializer -- none 
                        movq %r12, %r13
                        ## return address handling
                        movq %rbp, %rsp
                        popq %rbp
...
Cons.head:              ## method definition
                        ...
                        movq 24(%r12), %r13
.globl Cons.head.end
Cons.head.end:          ## method body ends
                        ## return address handling
                        movq %rbp, %rsp
                        popq %rbp
                        ret
...
Cons.tail:              ## method definition
                        ...
                        movq 32(%r12), %r13
.globl Cons.tail.end
Cons.tail.end:          ## method body ends
                        ## return address handling
                        movq %rbp, %rsp
                        popq %rbp
                        ret
...
List.head:              ## method definition
                        ...
                        movq %r14, 24(%r13)
.globl List.head.end
List.head.end:          ## method body ends
                        ## return address handling
                        movq %rbp, %rsp
                        popq %rbp
                        ret
...
List.tail:              ## method definition
                        ...
                        movq %r12, %r13
.globl List.tail.end
List.tail.end:          ## method body ends
                        ## return address handling
                        movq %rbp, %rsp
                        popq %rbp
                        ret
...
Main.print_list:        ## method definition
                        pushq %rbp
                        movq %rsp, %rbp
                        movq 16(%rbp), %r12
                        ## stack room for temporaries: 1
...
l8:                     pushq %r13
                        ## obtain vtable from object in r1 with static type List
                        movq 16(%r13), %r14
                        ## look up head() at offset 6 in vtable
                        movq 48(%r14), %r14
                        call *%r14
                        addq $8, %rsp
                        popq %rbp
...
l9:                     pushq %r13
                        ## obtain vtable from object in r1 with static type List
                        movq 16(%r13), %r14
                        ## look up tail() at offset 7 in vtable
                        movq 56(%r14), %r14
                        call *%r14
                        addq $8, %rsp
                        popq %rbp
                        ...
                        ## obtain vtable for self object of type Main
                        movq 16(%r12), %r14
                        ## look up print_list() at offset 9 in vtable
                        movq 72(%r14), %r14
                        call *%r14
                        addq $16, %rsp
                        popq %rbp
...
.globl Main.print_list.end
Main.print_list.end:    ## method body ends
                        ## return address handling
                        movq %rbp, %rsp
                        popq %rbp
                        ret
...
Main.main:              ## method definition
                        ...
                        ## self[3] holds field mylist (List)
                        ## method body begins
                        ## new List.cons(...).cons(...).cons(...).cons(...).cons(...)
                        pushq %r12
                        pushq %rbp
                        ## new Int
                        pushq %rbp
...
l10:                    pushq %r13
                        ## obtain vtable from object in r1 with static type List
                        movq 16(%r13), %r14
                        ## look up cons() at offset 8 in vtable
                        movq 64(%r14), %r14
                        call *%r14
                        addq $16, %rsp
                        popq %rbp
...
.globl string10
string10:               # "ERROR: 50: Exception: dispatch on void\\n"
.byte  69 # 'E'
.byte  82 # 'R'
.byte  82 # 'R'
.byte  79 # 'O'
...
.globl string11
string11:               # "ERROR: 108: Exception: dispatch on void\\n"
.byte  69 # 'E'
.byte  82 # 'R'
.byte  82 # 'R'
.byte  79 # 'O'
...
.globl string12
string12:               # "ERROR: 110: Exception: dispatch on void\\n"
.byte  69 # 'E'
.byte  82 # 'R'
.byte  82 # 'R'
.byte  79 # 'O'
...
.globl string14
string14:               # "ERROR: 112: Exception: dispatch on void\\n"
.byte  69 # 'E'
.byte  82 # 'R'
.byte  82 # 'R'
.byte  79 # 'O'
...
.globl string16
string16:               # "ERROR: 128: Exception: dispatch on void\\n"
.byte  69 # 'E'
.byte  82 # 'R'
.byte  82 # 'R'
.byte  79 # 'O'
...
.globl string17
string17:               # "ERROR: 129: Exception: dispatch on void\\n"
.byte  69 # 'E'
.byte  82 # 'R'
.byte  82 # 'R'
.byte  79 # 'O'
...
.globl string18
string18:               # "ERROR: 132: Exception: dispatch on void\\n"
.byte  69 # 'E'
.byte  82 # 'R'
.byte  82 # 'R'
.byte  79 # 'O'
