...
Main..new:              ## constructor for Main
			...
			movq %rax, %r12
                        ...
                        popq %rbp
                        movq %r13, 32(%r12)
                        ## self[5] holds field divisor (Int)
                        ## new Int
                        pushq %rbp
                        pushq %r12
                        movq $Int..new, %r14
                        ...
                        popq %rbp
                        movq %r13, 48(%r12)
                        ## self[7] holds field m (Object)
                        movq $0, %r13
                        movq %r13, 56(%r12)
                        ## self[3] out initializer <- { ... }
                        ## out_string(...)
                        pushq %r12
                        pushq %rbp
                        ## new String
                        ...
                        popq %r12
                        popq %rbp
                        ## string7 holds "2 is trivially prime..."
                        movq $string7, %r14
                        movq %r14, 24(%r13)
                        pushq %r13
                        pushq %r12
                        ...
                        movq %r14, 24(%r13)
                        movq %r13, 24(%r12)
                        ## self[4] testee initializer <- out
                        ## out
                        movq 24(%r12), %r13
                        movq %r13, 32(%r12)
                        ## self[5] divisor initializer -- none 
                        ## self[6] stop initializer <- 500
                        ## new Int
                        pushq %rbp
                        pushq %r12
                        movq $Int..new, %r14
                        ...
                        movq %r14, 24(%r13)
                        movq %r13, 48(%r12)
                        ## self[7] m initializer <- while true loop { ... } pool
.globl l1
l1:                     ## while conditional check
                        ## new Bool
                        pushq %rbp
                        pushq %r12
                        movq $Bool..new, %r14
...
l19:                    cmpq $0, %r14
			je l20
                        ...
                        jmp l19
.globl l20
l20:                    ## done with Object.copy loop
                        popq %r13
...
.globl string8
string8:                # "ERROR: 55: Exception: division by zero\\n"
.byte  69 # 'E'
.byte  82 # 'R'
.byte  82 # 'R'
.byte  79 # 'O'
...
.globl string12
string12:               # "ERROR: 75: Exception: dispatch on void\\n"
.byte  69 # 'E'
.byte  82 # 'R'
.byte  82 # 'R'
.byte  79 # 'O'
