...
l3:                     pushq %r13
                        ...
                        movq 16(%r13), %r14
                        ## look up f() at offset 6 in vtable
                        movq 48(%r14), %r14
                        call *%r14
                        addq $8, %rsp
                        popq %rbp
...
l4:                     pushq %r13
                        ## obtain vtable from object in r1 with static type A
                        movq 16(%r13), %r14
                        ## look up m() at offset 5 in vtable
                        movq 40(%r14), %r14
                        call *%r14
                        addq $8, %rsp
                        popq %rbp
...
.globl string10
string10:               # "ERROR: 5: Exception: dispatch on void\\n"
.byte  69 # 'E'
.byte  82 # 'R'
.byte  82 # 'R'
.byte  79 # 'O'
...
.globl string11
string11:               # "ERROR: 6: Exception: dispatch on void\\n"
.byte  69 # 'E'
.byte  82 # 'R'
.byte  82 # 'R'
.byte  79 # 'O'
