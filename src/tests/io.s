...
C.out_c:                ## method definition
                        ...
                        popq %r12
                        popq %rbp
                        ## string16 holds "C: Hello world\n"
                        movq $string16, %r14
                        movq %r14, 24(%r13)
                        pushq %r13
                        pushq %r12
                        ## obtain vtable for self object of type C
                        movq 16(%r12), %r14
                        ## look up out_string() at offset 8 in vtable
                        movq 64(%r14), %r14
                        call *%r14
...
l5:                     pushq %r13
                        ...
                        movq 16(%r13), %r14
                        ## look up out_a() at offset 5 in vtable
                        movq 40(%r14), %r14
                        call *%r14
                        addq $8, %rsp
                        popq %rbp
...
l6:                     pushq %r13
                        ...
                        movq 16(%r13), %r14
                        ## look up out_b() at offset 6 in vtable
                        movq 48(%r14), %r14
                        call *%r14
                        addq $8, %rsp
                        popq %rbp
...
l7:                     pushq %r13
                        ...
                        movq 16(%r13), %r14
                        ## look up out_c() at offset 9 in vtable
                        movq 72(%r14), %r14
                        call *%r14
                        addq $8, %rsp
                        popq %rbp
...
l8:                     pushq %r13
                        ...
                        movq 16(%r13), %r14
                        ## look up out_d() at offset 10 in vtable
                        movq 80(%r14), %r14
                        call *%r14
                        addq $8, %rsp
                        popq %rbp
...
.globl string13
string13:               # "ERROR: 55: Exception: dispatch on void\\n"
.byte  69 # 'E'
.byte  82 # 'R'
.byte  82 # 'R'
.byte  79 # 'O'
...
.globl string15
string15:               # "ERROR: 64: Exception: dispatch on void\\n"
.byte  69 # 'E'
.byte  82 # 'R'
.byte  82 # 'R'
.byte  79 # 'O'
...
.globl string19
string19:               # "ERROR: 96: Exception: dispatch on void\\n"
.byte  69 # 'E'
.byte  82 # 'R'
.byte  82 # 'R'
.byte  79 # 'O'
...
.globl string20
string20:               # "ERROR: 97: Exception: dispatch on void\\n"
.byte  69 # 'E'
.byte  82 # 'R'
.byte  82 # 'R'
.byte  79 # 'O'
...
.globl string21
string21:               # "ERROR: 98: Exception: dispatch on void\\n"
.byte  69 # 'E'
.byte  82 # 'R'
.byte  82 # 'R'
.byte  79 # 'O'
